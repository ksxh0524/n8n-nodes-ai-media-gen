...
Z-Image 节点用于生成 AI 图片，使用 OpenAI Z-Image API。
...
| 参数 | 类型 | 必填 | 默认值 | 说明 |
|------|------|------|---------|------|
| Model | options | 是 | z-image-turbo | 选择预设模型或自定义模型 |
...
```json
{
  ...
  "additionalParams": "{\"n\": 1, \"size\": \"1024x1024\"}"
}
```
...
{
  "model": "custom",
  "customModel": "dall-e-4",
  "addToConfig": "dall-e-4",
