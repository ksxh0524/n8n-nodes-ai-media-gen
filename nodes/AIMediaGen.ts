...
export class AIMediaGen implements INodeType {
	description: INodeTypeDescription = {
		...
		// Nano Banana - Size (for standard models)
		{
			...
			default: '1024x1024',
			options: [
				{ name: '1:1 (Square)', value: '1024x1024' },
				{ name: '2:3 (Portrait)', value: '832x1248' },
				{ name: '3:2 (Landscape)', value: '1248x832' },
				{ name: '3:4 (Portrait)', value: '864x1184' },
				{ name: '4:3 (Landscape)', value: '1184x864' },
				{ name: '4:5 (Portrait)', value: '896x1152' },
				{ name: '5:4 (Landscape)', value: '1152x896' },
				{ name: '9:16 (Portrait)', value: '768x1344' },
				{ name: '16:9 (Landscape)', value: '1344x768' },
				{ name: '21:9 (Ultrawide)', value: '1536x672' },
			],
